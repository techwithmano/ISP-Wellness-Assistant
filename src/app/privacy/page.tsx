...
const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.paragraph}>
        Welcome to Medical Diagnosis System. This Privacy Policy describes how we collect, use, disclose,
        and safeguard your information when you visit our website <strong>medical-diagnosis-system.com</strong> and use our medical
        questionnaire service within the <strong>Medical Diagnosis System application</strong>. By using the Service, you consent
      ...
      <ul style={styles.list}>
        ...
        <li>
          ...
          When you click "Download Report," a copy of the generated report is sent to you and a copy is sent to the owner of Medical Diagnosis System (sole operator).
        </li>
        <li>
      ...
      <p style={styles.paragraph}>
        The information you provide through your interaction with the Medical Diagnosis System application is utilized solely to enhance the
      ...
      <p style={styles.paragraph}>
        By accessing and utilizing the services provided through the Medical Diagnosis System application, you expressly acknowledge and
      ...
      <p style={styles.paragraph}>
        Medical Diagnosis System operates in compliance with the EU General Data Protection Regulation (GDPR) and the California Consumer
